...
## 11.0 확장: NVIDIA 스택 3종 추가 (E그룹)

| # | 기술 | 역할 | 예상 | 우선도 |
|---|-----|-----|-----|------|
| **E1** | **NeMo Evaluator** | Before/After 벤치마크 공식 채점 프레임워크 | 2h | 🔥 필수 |
| **E2** | **NVIDIA NIM** (명시) | Build API의 실제 백엔드 (문서·발표 문구 통일) | 0h | 🔥 필수 |
| **E3** | **cuML K-means** (Curator 내부) | semantic cluster 다양성 GPU 가속 | 1h | 💡 추가 |

이로써 **NVIDIA 스택 9종 → 12종** 확장. 발표에서 "12종 End-to-End" 주장 가능.
