...
| 지표 | **v1** 공식 가이드 | **v2.2** L1+L2 | **v3** +9종 고도화 |
|-----|:---:|:---:|:---:|
| 환각 비율 | 80% (4/5) | **0%** (0/50) 🎯 | **0%** 유지 |
| 평균 조문 인용 실존률 | 35% | **62%** (50건) | 🟡 **> 85% 목표** |
| CoT 4단계 구조 준수 | 일부 | 대부분 | **전부** |
| 법률 자문 고지 삽입 | ❌ | ✅ | ✅ |
| thinking/content 분리 | 섞임 | 깔끔 (nano_v3) | 깔끔 |
| 생성 처리량 | 0.23 rec/s | 0.23 rec/s | 🟡 **0.5+ rec/s** (D1·D3) |
| 1회차 통과율 | N/A | 45% | 🟡 **90%+ (루프 후)** |
| 민법-계약임대차 valid | N/A | 0.27 (최저) | 🟡 **0.6+ 목표** (화이트리스트 + C1) |
| 밤샘 복구 가능성 | 불가 | 불가 | ✅ (D4) |
| 최종 SFT 학습 데이터 | N/A | ~500 | 🟡 **1,500+ (C2 증폭)** |

> 🟡 = 본 생성·SFT 완료 후 실측값으로 업데이트 예정
